...
import com.jeffreypomeroy.easytape.MediaCodecWrapper;
...
public class PlaybackActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sample_playback);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.menu_play) {
        	dmy=1;
        	//xxxf: mAttribView is null below
    ...
    public void startPlayback() {
        ...
        // Construct a URI that points to the video resource that we want to play
       	...
       	mediaPath=VideoInfoActivity.getMediaPath();
            ...
            mTimeAnimator.setTimeListener(new TimeAnimator.TimeListener() {
                ...
                public void onTimeUpdate(final TimeAnimator animation,
                    ...
                    if ((out_bufferInfo.size <= 0 && isEos)) {
                        mTimeAnimator.end();
                        //xxxf below causes the app  to not go back to prior screen
                        //mCodecWrapper.stopAndRelease();
                        mExtractor.release();
